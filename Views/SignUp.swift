    ...
    var body: some View {
        ScrollView {
            ...
            VStack(alignment: .leading) {
                ...
                TextField("john@example.com", text: $user.email)
                ...
                Button {
                    ...
                    Task {
                        let error = await authService.signUp(email: user.email, password: user.password)
                        if error == nil {
                ...
                .disabled(isLoading || user.email.isEmpty || user.password.isEmpty)
                .frame(maxWidth: .infinity)
...
//#Preview {
//    SignUp(
//        currentPage: .constant(6), userName: user.name,
//        user: .constant("")
//    )
